 ...
 */
Blocktrail.prototype.createAddress = function() {
	return request.performRequest('wallet/' + blocktrail.WALLET + '/path', 'POST', {path: "M/0'/0"}, "address")
}
 ...
 * @returns Promise
 */
Blocktrail.prototype.createWebhook = function(identifier, address) {
	var postData = {
